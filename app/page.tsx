      ...
      />
            ...
            <div style={{ marginBottom: 10 }}>
              <label style={{ fontSize: 11, fontWeight: 600, color: colors.text3, letterSpacing: "0.06em", textTransform: "uppercase", display: "flex", alignItems: "center", gap: 6, marginBottom: 6 }}>
                Email
                <span style={{ fontSize: 9, fontWeight: 600, padding: "2px 7px", borderRadius: 20, background: dark ? "rgba(255,255,255,0.06)" : "rgba(0,0,0,0.06)", color: colors.text3, border: `1px solid ${colors.border}`, letterSpacing: "0.04em", textTransform: "uppercase" }}>optional</span>
              </label>
              <input
                value={email}
